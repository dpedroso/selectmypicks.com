	<div id="time"></div>	<div class="game" style="padding-bottom: 30px;">		<button id="randombutton" class="smbutton">Random Teams</button><button id="favoredbutton" class="smbutton">Favored Teams</button><button id="homebutton" class="smbutton">Home Teams</button>	</div><br />
	<div class="game" style="padding-bottom: 30px;">
